<?php
   include "koneksi.php";
   $jumlah_positif = mysqli_query($conn, "SELECT * from tweet3 where sentiment = 1");
   $jumlah_negatif = mysqli_query($conn, "SELECT * from tweet3 where sentiment = 0");
   $jumlah_netral = mysqli_query($conn, "SELECT * from tweet3 where sentiment = 2");
...
//    die
    ...
    $output = passthru("python worldcloud_positif2.py");
    $output2 = passthru("python wordcloud_negatif2.py");
    $output3 = passthru("python sering2.py");
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="analisa2.php">Analisa</a>
                    </div>
                </div>
            </li>
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <div class="row">
                                    ...
                                    <div class="card shadow mb-4">
                                            ...
                                            <div class="card-body">
                                                <img src="sering2.png" width="350" alt="">
                                            </div>
                                    </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="card-header py-3">
                                        ...
                                        <div class="card-body">
                                        <img src="wordcloud_positif2.png" width="1150" height="500" alt="">
                                        </div>
                                    </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="card-header py-3">
                                        ...
                                        <div class="card-body">
                                        <img src="wordcloud_negatif2.png" width="1150" height="500" alt="">
                                        </div>
                                    </div>
                                    </div>
                                </div>
