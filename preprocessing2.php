...
//    $data = mysqli_query($conn,"select * from tweet2");
   ...
   if(isset($_POST['proses']))
    {	
        $output = passthru("python preprocessing2.py");
        header("Location: preprocessing2.php");
    }
?>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="preprocessing2.php">Preprocessing</a>
                                ...
                                <div class="table-responsive mt-3">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                $data_setelah = mysqli_query($conn,"select * from tweet3");
